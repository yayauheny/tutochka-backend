...
When working with Hamster briefs, follow the standard Git workflow patterns outlined in [git_workflow.md](.trae/rules/git_workflow.md):
...
- [git_workflow.md](.trae/rules/git_workflow.md) - Standard Git branching and PR practices
- [dev_workflow.md](.trae/rules/dev_workflow.md) - General Task Master development patterns
- [tasks.md](.trae/rules/tasks.md) - Task structure and operations
