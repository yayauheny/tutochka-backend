package yayauheny.by.unit.importing.mapper
...
@DisplayName("RestroomImportMapper Tests")
class RestroomImportMapperTest {
    ...
    fun `should map candidate to create DTO`() {
        ...
        val dto = RestroomImportMapper.toCreateDto(candidate)
