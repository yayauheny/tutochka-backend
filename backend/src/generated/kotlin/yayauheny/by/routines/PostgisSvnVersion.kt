 ...
 */
@Suppress("warnings")
open class PostgisSvnVersion : AbstractRoutine<String>("postgis_svn_version", Public.PUBLIC, DSL.comment(""), SQLDataType.CLOB) {
    companion object {
    ...
    init {
        returnParameter = PostgisSvnVersion.RETURN_VALUE
    }
}
