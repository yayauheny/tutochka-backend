 ...
 */
@Suppress("warnings")
open class StAssvg3 : AbstractRoutine<String>("st_assvg", Public.PUBLIC, DSL.comment(""), SQLDataType.CLOB) {
    companion object {
        /**
    ...
    init {
        returnParameter = StAssvg3.RETURN_VALUE
        addInParameter(StAssvg3._1)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: String?): Unit = setValue(StAssvg3._1, value)
