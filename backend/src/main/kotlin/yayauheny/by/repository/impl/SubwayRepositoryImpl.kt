...
class SubwayRepositoryImpl(
    ...
    private fun lineProjection(): Array<org.jooq.SelectFieldOrAsterisk> =
        arrayOf(
            ...
            DSL.field("name_local", SQLDataType.VARCHAR(255)),
            DSL.field("name_local_lang", SQLDataType.VARCHAR(10)),
            DSL.field("short_code", SQLDataType.VARCHAR(20)),
    ...
    private fun stationProjection(): Array<org.jooq.SelectFieldOrAsterisk> =
        arrayOf(
            ...
            DSL.field("name_local", SQLDataType.VARCHAR(255)),
            DSL.field("name_local_lang", SQLDataType.VARCHAR(10)),
            DSL.field("is_transfer", SQLDataType.BOOLEAN),
            DSL.field("external_ids", SQLDataType.JSONB),
