...
lines AS (
    INSERT INTO subway_lines (city_id, name_ru, name_en, name_local, name_local_lang, hex_color, short_code)
    SELECT city_id,
           'Московская линия',
           'Moskovskaya line',
           'Маскоўская лінія',
...
VALUES
  -- Линия 1: Московская (Маскоўская лінія)
  ((SELECT line_id FROM l1), 'Малиновка', 'Malinovka', 'Малінаўка', 'be',
   ST_SetSRID(ST_MakePoint(27.4747, 53.8497), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Петровщина', 'Petrovshchina', 'Пятроўшчына', 'be',
   ST_SetSRID(ST_MakePoint(27.4568, 53.8629), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Михалово', 'Mikhalovo', 'Міхалаў', 'be',
   ST_SetSRID(ST_MakePoint(27.4421, 53.8747), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Грушевка', 'Grushevka', 'Грушаўка', 'be',
   ST_SetSRID(ST_MakePoint(27.4319, 53.8861), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Институт культуры', 'Institut kultury', 'Інстытут культуры', 'be',
   ST_SetSRID(ST_MakePoint(27.4221, 53.8980), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Площадь Ленина', 'Ploshchad Lenina', 'Плошча Леніна', 'be',
   ST_SetSRID(ST_MakePoint(27.5478, 53.8917), 4326), true, '{}'::jsonb), -- пересадка на Вокзальную
  ((SELECT line_id FROM l1), 'Октябрьская', 'Oktyabrskaya', 'Кастрычніцкая', 'be',
   ST_SetSRID(ST_MakePoint(27.5586, 53.8981), 4326), true, '{}'::jsonb), -- пересадка на Купаловскую
  ((SELECT line_id FROM l1), 'Площадь Победы', 'Ploshchad Pobedy', 'Плошча Перамогі', 'be',
   ST_SetSRID(ST_MakePoint(27.5720, 53.9081), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Площадь Якуба Коласа', 'Ploshchad Yakuba Kolasa', 'Плошча Якуба Коласа', 'be',
   ST_SetSRID(ST_MakePoint(27.5897, 53.9186), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Академия наук', 'Akademiya nauk', 'Акадэмія навук', 'be',
   ST_SetSRID(ST_MakePoint(27.6028, 53.9272), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Парк Челюскинцев', 'Park Chelyuskintsev', 'Парк Чалюскінцаў', 'be',
   ST_SetSRID(ST_MakePoint(27.6136, 53.9242), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Московская', 'Moskovskaya', 'Маскоўская', 'be',
   ST_SetSRID(ST_MakePoint(27.6278, 53.9279), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Восток', 'Vostok', 'Усход', 'be',
   ST_SetSRID(ST_MakePoint(27.6408, 53.9319), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Борисовский тракт', 'Borisovskiy trakt', 'Барысаўскі тракт', 'be',
   ST_SetSRID(ST_MakePoint(27.6668, 53.9368), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l1), 'Уручье', 'Uruchye', 'Уручча', 'be',
   ST_SetSRID(ST_MakePoint(27.6891, 53.9408), 4326), false, '{}'::jsonb),

  -- Линия 2: Автозаводская (Аўтазаводская лінія)
  ((SELECT line_id FROM l2), 'Каменная горка', 'Kamennaya gorka', 'Каменная горка', 'be',
   ST_SetSRID(ST_MakePoint(27.4378, 53.9068), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Кунцевщина', 'Kuntsevshchina', 'Кунцаўшчына', 'be',
   ST_SetSRID(ST_MakePoint(27.4128, 53.8961), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Спортивная', 'Sportivnaya', 'Спартыўная', 'be',
   ST_SetSRID(ST_MakePoint(27.3894, 53.8847), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Пушкинская', 'Pushkinskaya', 'Пушкінская', 'be',
   ST_SetSRID(ST_MakePoint(27.3656, 53.8747), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Молодежная', 'Molodezhnaya', 'Моладзежная', 'be',
   ST_SetSRID(ST_MakePoint(27.3431, 53.8639), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Фрунзенская', 'Frunzenskaya', 'Фрунзенская', 'be',
   ST_SetSRID(ST_MakePoint(27.3189, 53.8514), 4326), true, '{}'::jsonb), -- пересадка на Юбилейную площадь
  ((SELECT line_id FROM l2), 'Немига', 'Nemiga', 'Неміга', 'be',
   ST_SetSRID(ST_MakePoint(27.3011, 53.8390), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Купаловская', 'Kupalovskaya', 'Купалаўская', 'be',
   ST_SetSRID(ST_MakePoint(27.3300, 53.8401), 4326), true, '{}'::jsonb), -- пересадка на Октябрьскую
  ((SELECT line_id FROM l2), 'Первомайская', 'Pervomayskaya', 'Першамайская', 'be',
   ST_SetSRID(ST_MakePoint(27.3469, 53.8501), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Пролетарская', 'Proletarskaya', 'Пралетарская', 'be',
   ST_SetSRID(ST_MakePoint(27.3647, 53.8597), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Тракторный завод', 'Traktornyy zavod', 'Трактарны завод', 'be',
   ST_SetSRID(ST_MakePoint(27.3822, 53.8697), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Партизанская', 'Partizanskaya', 'Партызанская', 'be',
   ST_SetSRID(ST_MakePoint(27.4000, 53.8797), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Автозаводская', 'Avtozavodskaya', 'Аўтазаводская', 'be',
   ST_SetSRID(ST_MakePoint(27.4178, 53.8897), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l2), 'Могилевская', 'Mogilevskaya', 'Магілёўская', 'be',
   ST_SetSRID(ST_MakePoint(27.4356, 53.8997), 4326), false, '{}'::jsonb),

  -- Линия 3: Зеленолужская (Зеленалужская лінія)
  ((SELECT line_id FROM l3), 'Ковальская слобода', 'Kovalskaya sloboda', 'Кавальская Слабада', 'be',
   ST_SetSRID(ST_MakePoint(27.5131, 53.8931), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l3), 'Вокзальная', 'Vokzalnaya', 'Вакзальная', 'be',
  ...
  ((SELECT line_id FROM l3), 'Площадь Франтишка Богушевича', 'Ploshchad Frantishka Bogushevicha',
   'Плошча Францішка Богушэвіча', 'be',
   ST_SetSRID(ST_MakePoint(27.5308, 53.8824), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l3), 'Юбилейная площадь', 'Yubileynaya ploshchad', 'Юбілейная плошча', 'be',
   ST_SetSRID(ST_MakePoint(27.5397, 53.8769), 4326), true, '{}'::jsonb), -- пересадка на Фрунзенскую
  ((SELECT line_id FROM l3), 'Аэродромная', 'Aerodromnaya', 'Аэродромная', 'be',
   ST_SetSRID(ST_MakePoint(27.5494, 53.8669), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l3), 'Неморшанский сад', 'Nemorshanskiy sad', 'Нямаршанскі сад', 'be',
   ST_SetSRID(ST_MakePoint(27.5369, 53.8500), 4326), false, '{}'::jsonb),
  ((SELECT line_id FROM l3), 'Слуцкий гостинец', 'Slutskiy gostinets', 'Слуцкі гасцінец', 'be',
